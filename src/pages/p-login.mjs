  ...
  window.customElements.define(
    ...
    class extends HTMLElement {
      connectedCallback() {
        ...
        this.twoFactorAuthenticationInput = this.querySelector(
          "[data-selector=two-factor-input]"
        );
        this.twoFactorAuthenticationContainerNode = this.querySelector(
          "[data-selector=two-factor-container]"
        );

        this.changePasswordNode = this.querySelector(
          "[data-selector=change-password]"
        );
        this.changePasswordLink = this.querySelector(
          "[data-selector=change-password-link"
        );
        this.authenticationErrorNode = this.querySelector(
          "[data-selector=authentication-error]"
        );
      ...
      get showChangePasswordMessage() {
        ...
        this.changePasswordLink.setAttribute(
          "href",
          "https://partner.voipgrid.nl/user/login"
        );
